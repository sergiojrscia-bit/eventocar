...
| `docs/analista/HU-001-visualizar-filtrar-eventos.md` + `docs/analista/REQ-001-pagina-inicial.md` | História de usuário e requisitos da feature em desenvolvimento (substituem a antiga `especificacao-pagina-inicial.md`, que não existe mais no repositório) |
